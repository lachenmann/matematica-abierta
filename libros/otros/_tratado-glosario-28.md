...
De esta propiedad se deduce también la existencia de ínfimos para subconjuntos no vacíos acotados inferiormente. Además, todo cuerpo ordenado completo es arquimediano y, en consecuencia, su subcuerpo primo es denso. El cuerpo ordenado $\mathbb Q$ no es completo.

**En el Tratado:** [Definición 4.6.1 — Propiedad del supremo y cuerpo ordenado completo](../capitulos/tratado-de-analisis-capitulo-4-cuerpos-ordenados-y-el-problema-de-la-completitud.md#ta-propiedad-supremo-cuerpo-completo), [Proposición 4.6.2 — La propiedad del supremo implica la propiedad del ínfimo](../capitulos/tratado-de-analisis-capitulo-4-cuerpos-ordenados-y-el-problema-de-la-completitud.md#ta-supremo-implica-infimo) y [Teorema 4.6.3 — Todo cuerpo ordenado completo es arquimediano](../capitulos/tratado-de-analisis-capitulo-4-cuerpos-ordenados-y-el-problema-de-la-completitud.md#ta-completo-implica-arquimediano).

**Véase también:** [Propiedad del supremo](#gl-propiedad-supremo), [Supremo](#gl-supremo), [Ínfimo](#gl-infimo), [Propiedad arquimediana](#gl-propiedad-arquimediana), [Incompletitud de $\mathbb Q$](#gl-incompletitud-racionales).
...
La definición cuantifica sobre subconjuntos arbitrarios de $F$. En la base ZF del tratado es una afirmación de existencia, no un procedimiento computacional $A\mapsto\sup A$.

**En el Tratado:** [Definición 4.6.1 — Propiedad del supremo y cuerpo ordenado completo](../capitulos/tratado-de-analisis-capitulo-4-cuerpos-ordenados-y-el-problema-de-la-completitud.md#ta-propiedad-supremo-cuerpo-completo).

**Véase también:** [Cuerpo ordenado completo](#gl-cuerpo-ordenado-completo), [Supremo](#gl-supremo), [Cota superior](#gl-cota-superior), [Acotado superiormente](#gl-acotado-superiormente), [Incompletitud de $\mathbb Q$](#gl-incompletitud-racionales).
