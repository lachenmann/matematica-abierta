...
**Atribución y modificaciones:** Traducción no oficial al español de la sección 3F de [*Linear Algebra Done Right*, 4.ª ed.](https://linear.axler.net/LADR4e.pdf), de Sheldon Axler (PDF del 16-08-2026, pp. 105–118). El original y esta adaptación se presentan bajo [CC BY-NC 4.0](https://creativecommons.org/licenses/by-nc/4.0/). Matemática Abierta aporta la traducción, notas propias identificadas como `[NOTA]` y 33 soluciones originales `[SOL]`, que no proceden de Axler.
...
[Índice de esta edición](../../index.qmd).
