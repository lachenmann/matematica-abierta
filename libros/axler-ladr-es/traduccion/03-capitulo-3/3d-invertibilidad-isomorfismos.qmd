...
**Atribución y modificaciones:** Sheldon Axler, [*Linear Algebra Done Right*, 4.ª ed.](https://linear.axler.net/LADR4e.pdf), [CC BY-NC 4.0](https://creativecommons.org/licenses/by-nc/4.0/). Matemática Abierta aporta traducción, adaptación de presentación, notas identificadas como `[NOTA]` y soluciones originales `[SOL]`; estas últimas no son de Axler. No se reproducen imágenes de terceros.  
