...
| eigenvector | vector propio | Preferido frente a «autovector». |
| inner product | producto interno | Decisión provisional. |
| spectral theorem | teorema espectral | Estándar. |
| singular value decomposition | descomposición en valores singulares | Puede conservarse SVD. |
| tensor product | producto tensorial | Estándar. |
