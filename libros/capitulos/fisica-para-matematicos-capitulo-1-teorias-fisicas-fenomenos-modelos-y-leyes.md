...
provenance:
  ...
  sources:
    - cite: spivak2010physics
      locator: "prefacio, p. vii"
      role: exposition
    - cite: shankar2019fundamentals1
      locator: "cap. 1, §1.2, p. 3"
      role: exposition
    - cite: feynman2011lectures1
      locator: "vol. I, cap. 1, §1-1, pp. 1-1–1-2"
      role: idea
    - cite: hassani2013mathematical
      locator: "prefacio a la primera edición, p. xii"
      role: exposition
    - cite: arnold2014mathematical
      locator: "prefacio p. xiii; cap. 1, pp. 1–2"
      role: idea
    - cite: schramm2022methods
      locator: "cap. 1, pp. 3–5"
      role: exposition
