...
status: draft
publication-state: pending-qa-and-pr
...
provenance:
  ...
  note: "Versión web derivada del manuscrito canónico de Obsidian MA-ART-0008. No publicada ni sometida a Quarto QA."
---
...
Éste es `TA-THM-00054`. Las identidades $\delta_p+\delta_q=\delta_{p+q}$ y $\delta_p\delta_q=\delta_{pq}$ se verifican mediante la densidad racional y la regla de signos; junto con la compatibilidad del orden, muestran que $\iota_D$ es una incrustación de cuerpos ordenados (`TA-COR-00023`). Hemos alcanzado este punto **sin utilizar la propiedad del supremo**.
