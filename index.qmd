...
## De los apuntes de estudio a un proyecto abierto

El proyecto nació de una experiencia muy concreta: **mis propios apuntes de estudio comenzaron a acumularse**. Me di cuenta de que las conversaciones con las LLM y los apuntes de mis propios desarrollos podían compilarse y ser útiles para otros. Además, me interesaba generar textos "a medida"; es decir, textos que respondieran a mis propios intereses y mi manera particular de leer matemáticas. Por último, buscaba tener una plataforma que me permitiera leer matemáticas cómodamente en cualquier dispositivo, ya fuera computador, tablet o celular. Los PDF de LaTeX, si bien son maravillosas herramientas, no siempre se adaptan bien a la lectura en dispositivos móviles. 

A ello se suma un avance importante en las herramientas disponibles para estudiar y escribir matemáticas. Me di cuenta que las LLM hoy en día son capaces no solo de enseñar a un alto nivel, sino también de producir matemáticas propias, y que éstas además pueden ser formalizadas con LEAN. En consecuencia, no considero el trabajo de esta web como "slop", ya que ha sido fruto de lectura y estudio humano.

Es decir, estas herramientas no reemplazan el juicio matemático, las fuentes ni la demostración. Pero sí permiten construir un proceso de estudio y revisión **más sistemático, explícito y verificable**. Matemática Abierta nace también de la posibilidad de aprovechar ese nuevo entorno para transformar apuntes privados de estudio en recursos públicos que puedan leerse, discutirse, corregirse y reutilizarse. En ese sentido, el repositorio también se encuentra abierto y puede forkearse y modificarse en GitHub según las necesidades de cada lector.
